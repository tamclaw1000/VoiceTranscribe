...
| 2.4.46 | 89 | The transcript's speaker cell shows the row's `Speaker N / Voice M` pair beneath its label, so a named row no longer hides the combo it belongs to, and the Markdown export appends that pair to named rows |
